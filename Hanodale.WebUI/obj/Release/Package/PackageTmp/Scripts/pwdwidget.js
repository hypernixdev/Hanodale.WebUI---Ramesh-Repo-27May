...
function _MakePWDWidget(value)
{
	...
	code += "<input type='password' class='pwdfield  col-xs-10 col-sm-5' name='" + pwdname + "' maxlength = 25 id='" + this.pwdfieldid + "'>";

	this.pwdtxtfield=pwdname+"_text";

	this.pwdtxtfieldid = this.pwdtxtfield+"_id";

	code += "<input type='text' class='pwdfield  col-xs-10 col-sm-5'  name='" + pwdname + "' id='" + this.pwdtxtfieldid + "' maxlength = 25 style='display: none;'>";

	this.pwdshowdiv = pwdname+"_showdiv";

	this.pwdshow_anch = pwdname + "_show_anch";

	code += "<br/><br/><div class='pwdopsdiv' id='" + this.pwdshowdiv + "'><a href='#' id='" + this.pwdshow_anch + "'>" + this.txtShow + "</a></div>";
