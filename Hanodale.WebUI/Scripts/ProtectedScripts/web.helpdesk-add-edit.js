    ...
    var entityFunc = (function () {
       ...
       saveEntity = function (e) {
           ...
           if ($("#validation-form").valid()) {
               ...
               navigate.saveCallBack(actionUrl, param, message, null, null);
               $('#approvestockrequest').hide();
           } else {
       ...
       saveapprovalEntity = function () {
           if ($("#validation-form").valid()) {
               var message = $("#MSG_CONFIRM_SAVE").val();
               var actionUrl =  partName + "/SaveApproval" + partName + "/";
               var param = $('#validation-form').serialize();
               param = addDatetime(param);
               navigate.saveCallBack(actionUrl, param, message, null, null);
               $('#approve-purchaseorder').attr("disabled", true);
               $('#update-purchaseorder').attr("disabled", true);
           }
