...
namespace Hanodale.WebUI.Controllers
{
    public partial class NewsController
    {
        ...
        [NonAction]
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public virtual System.Web.Mvc.ActionResult BindNews()
        {
            return new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.BindNews);
        }
        [NonAction]
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public virtual System.Web.Mvc.JsonResult SaveNews()
        {
            return new T4MVC_System_Web_Mvc_JsonResult(Area, Name, ActionNames.SaveNews);
        }
        [NonAction]
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        ...
        public class ActionNamesClass
        {
            ...
            public readonly string BindNews = "BindNews";
        ...
        public class ActionNameConstants
        {
            ...
            public const string BindNews = "BindNews";
        ...
        static readonly ActionParamsClass_BindNews s_params_BindNews = new ActionParamsClass_BindNews();
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public ActionParamsClass_BindNews BindNewsParams { get { return s_params_BindNews; } }
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public class ActionParamsClass_BindNews
        {
        ...
        public class ViewsClass
        {
            ...
            public readonly string RenderAction = "~/Views/News/RenderAction.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_NewsController : Hanodale.WebUI.Controllers.NewsController
    {
        ...
        [NonAction]
        partial void NewsOverride(T4MVC_System_Web_Mvc_JsonResult callInfo);

        [NonAction]
        public override System.Web.Mvc.JsonResult News()
        {
        ...
        [NonAction]
        partial void BindNewsOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Hanodale.WebUI.Models.DataTableModel param);

        [NonAction]
        public override System.Web.Mvc.ActionResult BindNews(Hanodale.WebUI.Models.DataTableModel param)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.BindNews);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "param", param);
            BindNewsOverride(callInfo, param);
            return callInfo;
        }
        ...
        [NonAction]
        partial void SaveNewsOverride(T4MVC_System_Web_Mvc_JsonResult callInfo, Hanodale.WebUI.Models.NewsModel model);

        [NonAction]
        public override System.Web.Mvc.JsonResult SaveNews(Hanodale.WebUI.Models.NewsModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_JsonResult(Area, Name, ActionNames.SaveNews);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
            SaveNewsOverride(callInfo, model);
            return callInfo;
        }
