...
namespace Hanodale.WebUI.Models
{
    public class BusinessUserModel
    {
        ...
        //[Display(Name = "USER_EMPLOYEE_NO", ResourceType = typeof(Resources))]
        //[StringLength(50, ErrorMessage = "The Maximum length is {1} characters")]
    ...
    public partial class BusinessUserViewModel
    {
        public List<BusinessUserModel> lstBusinessUserModel { get; set; }
    }
